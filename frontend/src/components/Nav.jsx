    ...
    <div className="relative flex justify-between items-center px-[90px] py-[10px] font-secondary text-heading_2 text-tx_primary font-medium">
        ...
        : ( <div className="flex gap-[10px]">
         { user.profile_pic 
          ...
          <div onClick={()=>{setShowNotification(!showNotification)}} className="cursor-pointer h-[50px] w-[50px] flex justify-center items-center rounded-full bg-bg_primary border border-br_primary focus:outline-none focus:ring-2 focus:ring-blue-400">
          <FaBell color="#59ACFF"/>
          </div>
          </div>
        )
...
{
  showNotification &&
  <div className="absolute right-[10px] w-[200px] h-[50vh] top-[100px] rounded-[10px] px-[10px] py-[5px] bg-bg_primary text-tx_primary text-base font-secondary border border-br_primary focus:outline-none focus:ring-2 focus:ring-blue-400">
